    ...
    <div :class="getFooterCellClasses(getRawValueForCSS(data), itemType)" class="whitespace-nowrap">
        <template v-if="getFooterDualData(data, itemType)?.type === 'both'">
            <div v-if="getFooterDualData(data, itemType)?.closed" class="footer-dual-mode">
                <div class="actual" :class="getValueColorClasses(getFooterDualData(data, itemType)?.actual, itemType)">
        ...
        <template v-else>
            ...
            <div v-else :class="getValueColorClasses(getFooterDualData(data, itemType)?.value, itemType)">
                {{ getFooterDualData(data, itemType)?.value }}
            </div>
        </template>
    </div>
