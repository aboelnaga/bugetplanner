...
const getExpensesTooltip = (monthIndex) => {
  ...
  const actualAmount = props.calculateMonthlyActualExpenses
  ...
  return buildTooltip(
      ...
      actualAmount,
      'expense',
      actualColorFor(actualAmount, 'expense')
    )
}

const getInvestmentOutgoingTooltip = (monthIndex) => {
  const planned = props.calculateMonthlyPlannedInvestmentOutgoing
    ? props.calculateMonthlyPlannedInvestmentOutgoing(monthIndex)
    : 0
  const actual = props.calculateMonthlyActualInvestmentOutgoing
...
const getExpensesYearlyTooltip = () => {
  ...
  const actualAmount = props.calculateGrandTotalActualExpenses
...
const getInvestmentOutgoingYearlyTooltip = () => {
  const planned = props.calculateGrandTotalPlannedInvestmentOutgoing
    ? props.calculateGrandTotalPlannedInvestmentOutgoing()
    : 0
  const actual = props.calculateGrandTotalActualInvestmentOutgoing
...
const getPreviousYearInvestmentOutgoingTooltip = () => {
  ...
  if (detailedValues) {
    ...
    return (
      `PY ${previousYear} Investment Purchases<br>` +
