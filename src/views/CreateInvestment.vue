    ...
    <Card>
      <template #content>
        ...
        >
          ...
          <div
            v-if="form.investment_type === 'real_estate'"
            class="space-y-6"
          >
            <Divider>
          ...
          <div
            v-if="form.investment_type === 'precious_metals'"
            class="space-y-6"
          >
            <Divider>
          ...
          <div class="space-y-4">
            ...
            <div
              v-for="(link, index) in form.document_links"
              :key="index"
          ...
          <div class="flex items-center justify-between">
            <div class="text-sm">
              ...
              >Please fix errors</span>
              <span
                v-else
                class="text-green-600 font-medium"
              >All fields valid</span>
            </div>
