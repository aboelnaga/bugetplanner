<template>
  <div class="space-y-6">
    <div class="flex justify-between items-center">
      ...
      <button class="btn-primary">Add Income Source</button>
    </div>
    ...
    <div class="card">
      <h3 class="text-lg font-semibold mb-4">Income Sources</h3>
    ...
    <div class="card">
      <h3 class="text-lg font-semibold mb-4">Salary Growth Projection</h3>
      <p class="text-gray-600 mb-4">Based on your historical data and planned raises</p>
      <div class="bg-gray-50 p-4 rounded-lg">
        <p class="text-sm text-gray-600">Next projected raise: <span class="font-semibold">May 2025</span></p>
        <p class="text-sm text-gray-600">Expected increase: <span class="font-semibold text-green-600">15-20%</span></p>
      </div>
    </div>
  </div>
</template>
